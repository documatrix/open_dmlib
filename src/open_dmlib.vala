...
namespace OpenDMLib
{
  ...
  public class ProcessSpawner
  {
    ...
    public void spawn_process( string commandline, bool hide_window = false, string? logfile = null, string? current_directory = null ) throws OpenDMLibError.PROCESS_SPAWN_ERROR
    {
      ...
      executed = Windows.ThreadsAPI.CreateProcess( null, Win32.locale_filename_from_utf8( commandline ), null, null, true, create_no_window | Windows.ThreadsAPI.CREATE_UNICODE_ENVIRONMENT, null, current_win_directory, &si, &pi );
